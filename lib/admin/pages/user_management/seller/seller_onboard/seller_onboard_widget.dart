...
import 'seller_onboard_model.dart';
export 'seller_onboard_model.dart';

class SellerOnboardWidget extends StatefulWidget {
  const SellerOnboardWidget({super.key});

  @override
  State<SellerOnboardWidget> createState() => _SellerOnboardWidgetState();
}

class _SellerOnboardWidgetState extends State<SellerOnboardWidget> {
  late SellerOnboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SellerOnboardModel());
