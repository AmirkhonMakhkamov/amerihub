...
import 'sellers_admin_model.dart';
export 'sellers_admin_model.dart';

class SellersAdminWidget extends StatefulWidget {
  const SellersAdminWidget({super.key});

  @override
  State<SellersAdminWidget> createState() => _SellersAdminWidgetState();
}

class _SellersAdminWidgetState extends State<SellersAdminWidget> {
  late SellersAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SellersAdminModel());
