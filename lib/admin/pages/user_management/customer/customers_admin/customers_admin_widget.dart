...
import 'customers_admin_model.dart';
export 'customers_admin_model.dart';

class CustomersAdminWidget extends StatefulWidget {
  const CustomersAdminWidget({super.key});

  @override
  State<CustomersAdminWidget> createState() => _CustomersAdminWidgetState();
}

class _CustomersAdminWidgetState extends State<CustomersAdminWidget> {
  late CustomersAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomersAdminModel());
