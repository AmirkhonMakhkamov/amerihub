...
import 'employees_admin_model.dart';
export 'employees_admin_model.dart';

class EmployeesAdminWidget extends StatefulWidget {
  const EmployeesAdminWidget({super.key});

  @override
  State<EmployeesAdminWidget> createState() => _EmployeesAdminWidgetState();
}

class _EmployeesAdminWidgetState extends State<EmployeesAdminWidget> {
  late EmployeesAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeesAdminModel());
