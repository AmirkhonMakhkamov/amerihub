...
import 'media_admin_model.dart';
export 'media_admin_model.dart';

class MediaAdminWidget extends StatefulWidget {
  const MediaAdminWidget({super.key});

  @override
  State<MediaAdminWidget> createState() => _MediaAdminWidgetState();
}

class _MediaAdminWidgetState extends State<MediaAdminWidget>
    with TickerProviderStateMixin {
  late MediaAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MediaAdminModel());
