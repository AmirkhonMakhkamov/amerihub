...
import 'settings_admin_model.dart';
export 'settings_admin_model.dart';

class SettingsAdminWidget extends StatefulWidget {
  const SettingsAdminWidget({super.key});

  @override
  State<SettingsAdminWidget> createState() => _SettingsAdminWidgetState();
}

class _SettingsAdminWidgetState extends State<SettingsAdminWidget> {
  late SettingsAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsAdminModel());
    ...
    _model.addressline1TextController ??=
        TextEditingController(text: currentUserDocument?.address.addressLine1);
    _model.addressline1FocusNode ??= FocusNode();

    _model.addressline2TextController ??=
        TextEditingController(text: currentUserDocument?.address.addressLine2);
    ...
    _model.postcodeTextController ??=
        TextEditingController(text: currentUserDocument?.address.pinCode);
