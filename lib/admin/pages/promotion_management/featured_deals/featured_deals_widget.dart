...
import 'featured_deals_model.dart';
export 'featured_deals_model.dart';

class FeaturedDealsWidget extends StatefulWidget {
  const FeaturedDealsWidget({super.key});

  @override
  State<FeaturedDealsWidget> createState() => _FeaturedDealsWidgetState();
}

class _FeaturedDealsWidgetState extends State<FeaturedDealsWidget>
    with TickerProviderStateMixin {
  late FeaturedDealsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeaturedDealsModel());
