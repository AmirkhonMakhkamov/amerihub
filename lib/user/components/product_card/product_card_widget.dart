        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Container(
                      width: () {
                        if (MediaQuery.sizeOf(context).width < 400.0) {
                          return 30;
                        } else if (MediaQuery.sizeOf(context).width < 500.0) {
                          return 45;
                        } else if (MediaQuery.sizeOf(context).width > 600.0) {
                          return 60;
                        } else {
                          return 30;
                        }
              ...
              Expanded(
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(15.0, 9.0, 15.0, 0.0),
                  child: OctoImage(
