...
import 'login_as_model.dart';
export 'login_as_model.dart';

class LoginAsWidget extends StatefulWidget {
  const LoginAsWidget({super.key});

  @override
  State<LoginAsWidget> createState() => _LoginAsWidgetState();
}
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/neomart-logo.png',
                    width: 100.0,
                    fit: BoxFit.contain,
                  ),
                ),
                Padding(
                  ...
                  child: Text(
                    'Personalize the neomart for yourself !',
