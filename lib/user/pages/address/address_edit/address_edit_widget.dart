  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<AddressesRecord>(
          stream: AddressesRecord.getDocument(widget.ref!),
          builder: (context, snapshot) {
            ...
            final containerAddressesRecord = snapshot.data!;
            return Container(
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController1 ??=
                                      ...
                                      text:
                                          containerAddressesRecord.address.name,
                                    ),
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.textController7 ??=
                                        TextEditingController(
                                      text:
                                          containerAddressesRecord.address.city,
                                    ),
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await widget.ref!.update(createAddressesRecordData(
                            address: createAddressStruct(
                              id: containerAddressesRecord.reference.id,
