...
class ProductStruct extends FFFirebaseStruct {
  ...
  // "variant" field.
  VariantCheckoutStruct? _variant;
  VariantCheckoutStruct get variant => _variant ?? VariantCheckoutStruct();
  set variant(VariantCheckoutStruct? val) => _variant = val;

  void updateVariant(Function(VariantCheckoutStruct) updateFn) {
    updateFn(_variant ??= VariantCheckoutStruct());
  }
  ...
  static ProductStruct fromMap(Map<String, dynamic> data) => ProductStruct(
        ...
        variant: VariantCheckoutStruct.maybeFromMap(data['variant']),
      );
  ...
  static ProductStruct fromSerializableMap(Map<String, dynamic> data) =>
      ProductStruct(
        ...
        variant: deserializeStructParam(
          data['variant'],
          ParamType.DataStruct,
          false,
...
ProductStruct createProductStruct({
  ...
  bool delete = false,
    ...
    ProductStruct(
      ...
      salePrice: salePrice,
      quantity: quantity,
      variant: variant ?? (clearUnsetFields ? VariantCheckoutStruct() : null),
...
Map<String, dynamic> getProductFirestoreData(
  ...
  // Handle nested data for "variant" field.
  addVariantCheckoutStructData(
    firestoreData,
    product.hasVariant() ? product.variant : null,
    'variant',
    forFieldValue,
  );
