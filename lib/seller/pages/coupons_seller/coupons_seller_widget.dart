...
import 'coupons_seller_model.dart';
export 'coupons_seller_model.dart';

class CouponsSellerWidget extends StatefulWidget {
  const CouponsSellerWidget({super.key});

  @override
  State<CouponsSellerWidget> createState() => _CouponsSellerWidgetState();
}

class _CouponsSellerWidgetState extends State<CouponsSellerWidget> {
  late CouponsSellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CouponsSellerModel());
                                              ...
                                              Expanded(
                                                child: TextFormField(
                                                  ...
                                                  decoration: InputDecoration(
                                                    ...
                                                    hintText:
                                                        'Search by title, code or discount...',
